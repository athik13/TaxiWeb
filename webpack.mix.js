...
mix
    ...
    /* Display CSS and JS */
    .sass('resources/sass/dhivehi.scss', 'public/css/dhivehi.css')
    .sass('resources/sass/display.scss', 'public/css/display.css')
    .js('resources/js/display.js', 'public/js/display.js')
