...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <title>TaxiWeb - Taxi managing Dashboard</title>

        <meta name="description" content="TaxiWeb - Taxi managing Dashboard created by pixelcave and published on Themeforest">
            ...
            <aside id="side-overlay" class="font-size-sm">
                ...
                <div class="content-header border-bottom">
                    ...
                    <a class="img-link mr-1" href="javascript:void(0)">
                        <img class="img-avatar img-avatar32" src="{{ asset('media/avatars/avatar1.jpg') }}" alt="">
                    </a>
                    <!-- END User Avatar -->

                    <!-- User Info -->
                    <div class="ml-2">
                        <a class="link-fx text-dark font-w600" href="javascript:void(0)">[USER NAME]</a>
                    </div>
                    <!-- END User Info -->
                ...
                <div class="content-header bg-white-5">
                    ...
                    <a class="font-w600 text-dual" href="/">
                        <span class="smini-visible">
                            <span class="text-primary">T </span><span class="">W</span>
                        </span>
                        <span class="smini-hide">
                            <span class="text-primary">Taxi </span><span class="font-w700 font-size-h5">web</span>
                        </span>
                    </a>
                    <!-- END Logo -->
                ...
                <div class="content py-3">
                    <div class="row font-size-sm">
                        <div class="col-sm-6 order-sm-2 py-1 text-center text-sm-right">
                            Crafted with <i class="fa fa-heart text-danger"></i> by <a class="font-w600" href="#">blank.mv</a>
                        </div>
                        <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-left">
                            <a class="font-w600" href="#">TaxiWeb</a> &copy; <span data-toggle="year-copy"></span>
                        </div>
                    </div>
                </div>
            </footer>
